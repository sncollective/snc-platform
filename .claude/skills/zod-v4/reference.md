...
// ISO validators (v4) — prefer over z.string().datetime() for date/time fields
z.iso.datetime()        // ISO 8601 datetime string (e.g. "2024-01-15T09:30:00Z")
z.iso.date()            // ISO 8601 date string (e.g. "2024-01-15")
z.iso.time()            // ISO 8601 time string (e.g. "09:30:00")
z.iso.duration()        // ISO 8601 duration (e.g. "P1Y2M3D")
// Chainable: z.iso.datetime().nullable(), z.iso.datetime().optional(), z.iso.datetime().default(...)
