...
- [ ] `platform/liquidsoap/playout.liq` AAC encoder bitrate bumped from 128k to 256k
- [ ] Playout config regenerated
- [ ] Liquidsoap restart verified locally (dev docker compose)
