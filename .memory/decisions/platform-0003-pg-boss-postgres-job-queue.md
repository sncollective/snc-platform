...
- [../../.research/analysis/briefs/job-queue-libraries.md](../../.research/analysis/briefs/job-queue-libraries.md) — full evaluation of pg-boss vs BullMQ vs Graphile Worker vs Temporal vs Custom SKIP LOCKED
