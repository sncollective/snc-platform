---
id: streaming-chatbot-integration
...
See [live-streaming-ux-patterns.md §3.9 Ecosystem mod tools](../../.research/analysis/briefs/live-streaming-ux-patterns.md) for the Twitch bot ecosystem reference (Nightbot, Fossabot, StreamElements, Sery_Bot) and the co-op-aligned posture recommended by research:
