...
See [live-streaming-ux-patterns.md §2 Chat](../../.research/analysis/briefs/live-streaming-ux-patterns.md) — the full chat rendering surface applies equally to replay (badges, emotes, mentions, reactions, pinned messages). Specifically:
