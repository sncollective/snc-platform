...
- [platform-0001-srs-unified-streaming-server.md](../../.memory/decisions/platform-0001-srs-unified-streaming-server.md) — SRS operational mechanics
- [platform-0003-pg-boss-postgres-job-queue.md](../../.memory/decisions/platform-0003-pg-boss-postgres-job-queue.md) — job queue choice
- [platform-0004-vidstack-media-player.md](../../.memory/decisions/platform-0004-vidstack-media-player.md) — client-side player
- [platform-0008-srs-vs-mediamtx-tv-model.md](../../.memory/decisions/platform-0008-srs-vs-mediamtx-tv-model.md) — TV model + SRS vs MediaMTX comparative reasoning
- [platform-0009-liquidsoap-playout-engine.md](../../.memory/decisions/platform-0009-liquidsoap-playout-engine.md) — always-on channel playout engine
