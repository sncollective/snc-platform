...
ALTER TABLE "creator_profiles" ADD COLUMN "owner_id" text NOT NULL
  DEFAULT '' REFERENCES "users"("id") ON DELETE CASCADE;
UPDATE "creator_profiles" SET "owner_id" = "user_id";
ALTER TABLE "creator_profiles" ALTER COLUMN "owner_id" DROP DEFAULT;
...
-- 2. creator_members table + seed existing owners
...
-- 4. Repoint subscription_plans FK
