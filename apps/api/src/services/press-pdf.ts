...
.density-compact .v-highlight figure{width:74px;min-height:56px}.density-compact .v-highlight{grid-template-columns:74px minmax(0,1fr)}
...
.density-tight .v-highlight figure{width:60px;min-height:48px}.density-tight .v-highlight{grid-template-columns:60px minmax(0,1fr)}
`;
