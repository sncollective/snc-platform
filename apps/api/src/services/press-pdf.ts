...
.density-compact .v-member figure,.density-compact .v-member img{width:44px;height:44px}
.density-compact .v-highlight figure,.density-compact .v-highlight img{width:56px;height:56px}
...
.density-tight .v-member figure,.density-tight .v-member img{width:40px;height:40px}
.density-tight .v-highlight figure,.density-tight .v-highlight img{width:48px;height:48px}
`;
