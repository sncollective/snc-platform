...
export const makeTestConfig = (overrides?: Partial<Config>): Config => ({
  ...
  LIQUIDSOAP_CONFIG_DIR: undefined as string | undefined,
  LIQUIDSOAP_CALLBACK_HOST: undefined as string | undefined,
  LIQUIDSOAP_CALLBACK_PORT: undefined as string | undefined,
  SRS_RTMP_HOST: undefined as string | undefined,
