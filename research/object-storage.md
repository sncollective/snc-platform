...
- **Web-based large file upload** — Seafile's own web portal struggles with multi-GB uploads (noted in `../../docs/research/collaboration-suite.md`); a proper chunked upload UI could fill this gap
...
- [S/NC collaboration suite](../../docs/research/collaboration-suite.md) — Seafile deployment and status
